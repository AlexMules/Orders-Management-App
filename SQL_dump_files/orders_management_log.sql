...
CREATE TABLE `log` (
  ...
  CONSTRAINT `fk_log_order` FOREIGN KEY (`idOrder`) REFERENCES `order` (`id`)
...
INSERT INTO `log` VALUES (1,1,'Mihai Stanescu','Mouse Razer',2,500),(2,2,'Andreea Munteanu','Casti HyperX',1,300);
